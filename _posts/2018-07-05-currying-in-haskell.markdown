---
layout: post
title: Understanding Currying in Haskell
date: 2018-07-05 15:09:00 +0300
description: You’ll find this post in your `_posts` directory. Go ahead and edit it and re-build the site to see your changes. # Add post description (optional)
img: haskell.jpg # Add image post (optional)
tags: [Programming, Haskell, Functional Programming] # add tag
---
